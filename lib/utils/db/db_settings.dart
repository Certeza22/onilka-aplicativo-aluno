...
const String createTableUsersScript =
    'CREATE TABLE IF NOT EXISTS users(id INTEGER PRIMARY KEY, nome TEXT, bi TEXT, email TEXT, token TEXT, primeiroAcesso INTEGER, atualizarDadosCadastrais INTEGER, celular TEXT)';
