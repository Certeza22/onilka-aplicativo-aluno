...
class RecomendacaoAlunoRepository implements IRecomendacaoAluno {
  ...
  Future<RecomendacaoAlunoDto> obterRecomendacaoAluno(
    ...
    final url = Uri.parse(
      '${AppConfigReader.getApiHost()}/Aluno/recomendacao-aluno?codigoAluno=$codigoAluno&codigoTurma=$codigoTurma&anoLetivo=$anoLetivo&trimestre=$trmestre&modalidade=$modalidade',
    );
    try {
