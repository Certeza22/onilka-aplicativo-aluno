...
class TermsRepository extends ITermsRepository {
  ...
  @override
  Future<Term> fetchTerms(String bi) async {
    try {
      final url = Uri.parse('${AppConfigReader.getApiHost()}/TermosDeUso?bi=$bi');
  ...
  @override
  Future<bool> registerTerms(int termoDeUsoId, String bi, String device, String ip, double versao) async {
    final Map data = {
