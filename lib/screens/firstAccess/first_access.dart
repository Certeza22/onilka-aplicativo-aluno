...
import 'package:bi_nif_validator/bi_validator.dart';
...
class FirstAccessState extends State<FirstAccess> {
  ...
  void initState() {
    super.initState();
    _termsController.fetchTermo(widget.bi);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final String userBi = BIValidator.format(widget.bi);
                  ...
                  Column(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: AutoSizeText(
                          'Primeiro Acesso! Cadastre uma nova senha para o BI: $userBi',
                          maxFontSize: 18,
                          minFontSize: 16,
