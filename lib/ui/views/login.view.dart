...
class LoginViewState extends State<LoginView> {
  ...
  Future<void> handleSignIn(
    ...
    try {
      ...
      final UsuarioDataModel usuario = await autenticacaoController.authenticateUser(bi, password);
            ...
            child: Column(
              children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border(
                                bottom: BorderSide(
                                  color: _biIsError ? Colors.red : const Color(0xffD06D12),
                          ...
                          Container(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Nav.push(context, RecoverPassword(input: _biRaw));
                              },
                          ...
                          _carregando
                              ...
                              : EADefaultButton(
                                  ...
                                  enabled: BIValidator.isValid(_bi) && _password.length >= 7,
                                  onPress: () {
                                    if (_formKey.currentState!.validate()) {
                                      handleSignIn(_bi, _password);
                                    } else {
                                      setState(() {
                                        _biIsError = true;
                ...
                Container(
                  ...
                  child: Image.asset('assets/images/logo_onilka.png', fit: BoxFit.cover),
                ),
              ],
            ),
          ),
