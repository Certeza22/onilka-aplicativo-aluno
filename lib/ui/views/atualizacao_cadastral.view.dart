...
class AtualizacaoCadastralViewState extends State<AtualizacaoCadastralView> {
  ...
  final MaskedTextController _biCtrl = MaskedTextController(mask: '000.000.000-00');
  ...
  Future<void> loadInputs() async {
    setState(() {
      ...
      _biCtrl.text = usuarioStore.usuario?.bi != null ? usuarioStore.usuario!.bi : '';
